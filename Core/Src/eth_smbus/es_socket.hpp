#ifndef SRC_ETH_SMBUS_ES_SOCKET_H_
#define SRC_ETH_SMBUS_ES_SOCKET_H_
...
public:
    ...
    {
        _port = port;
        SocketBase::bind(ESTYPE_APP_S2M_PORT(appid), ESTYPE_APP_M2S_PORT(_port, appid));
    }

    void ether_send(ESReg_t reg, const void* data, size_t len)
    {
        uint8_t reg_type = ESTYPE_REG_2_REGTYPE(_port, reg);
...
private:
    ...
    {
        this->eth_callback((ESReg_t)ESTYPE_REGTYPE_2_REG(reg_type), data, len);
    }
};
...
#endif /*SRC_ETH_SMBUS_ES_SOCKET_H_*/
